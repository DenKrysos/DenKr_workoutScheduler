...
#   (But actually, this is a little to low Volume. The Profile in "muscle.py" called "muscle_setup_default" would be more like the optimum volume. But this would require about 5-6 Muscles per Workout or 4-5 Workouts-per-Week, which would be most likely too much a dedication for most people.)
#   (So you might very well work with this profile here and still live on with a good and calm conscience.)
muscle_setup=[
    (muscleID.chest,1,1.55,10),# 2 per Week
    (muscleID.back,1,1.55,10),# 2 per Week
...
exercise_setup=[
    ...
    ("Sling, Sprinting Calf Press (Uni- or Bi-lateral)", True,
        1.0,
        [equipID.Sling],
        [(muscleID.calves,1)]
    ),

...
def print_introduction():
    ...
    globV.HCI.printStd(f"In case, you are working terminal now, but like to use the GUI, open the File \"./{config_file_subpath}/{config_file_prefix+config_file_fname+config_file_fExt}\" and change 'UsageMethodology' to \"useMeth.GUI\".")
    globV.HCI.printStd("")
